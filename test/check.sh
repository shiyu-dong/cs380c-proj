...
for PROGRAM in base_test split_reuse_inner_name_bug two_vector_args parallel \
  ...
  fibonacci \
  chunk_sharing mod logical c_function vector_cast vector_math
#seg fault: #parallel_alloc vector_bounds_inference bounds_inference bounds_inference_chunk chunk split_store_compute
